...
Password		<br><input type="password" placeholder="Password" name="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
required /><br>
DOB				<br><input type="date" name="DoB" required/><br>
Mobile Number	<br><input type="number" placeholder="Mobile Number" name="mobileNo" maxlength="10" pattern="\d{10}" title="Enter a Valid Mobile Number" required/><br>
